    ...
    private PartitionMetadata findLeader(List<String> a_seedBrokers, int a_port, String a_topic, int a_partition) {
        ...
        for (String seed : a_seedBrokers) {
            ...
            try {
                ...
                TopicMetadataRequest req = new TopicMetadataRequest(Collections.singletonList(a_topic));
                ...
                System.out.println("Error communicating with Broker[" + seed + "]to findLeader for[" + a_topic + "," + a_partition + "]Reason:" + e);
            } finally {
                if (consumer != null)
                    consumer.close();
            }
